...
\newcommand{\Chris}[1]{{\color{magenta}{\bf\sf [Chris: #1]}}}
\newcommand{\Carlos}[1]{{\color{blue}{\bf\sf [Carlos: #1]}}}
\newcommand{\Leo}[1]{{\color{green}{\bf\sf [Leo: #1]}}}
\newcommand{\Ashish}[1]{{\color{green}{\bf\sf [Ashish: #1]}}}
