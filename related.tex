...
where (as in our own work), pose is explicitly separated from content and an autoencoder is trained to predict small transformations of an image \Jon{fix this description}.	
...
\Jon{where minibatches only allow one type of variable to vary}.
